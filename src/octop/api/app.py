...
def build_app(server: OctopServer) -> FastAPI:
    ...
    _mount_routers(
        ...
        [
            ...
            _RouterMount(host_apps.router, "/api", ["host-apps"]),
            _RouterMount(knowledge_bases.router, "/api", ["knowledge"]),
            _RouterMount(projects.router, "/api/projects", ["projects"]),
            _RouterMount(local_models.router, "/api/local-models", ["local-models"]),
