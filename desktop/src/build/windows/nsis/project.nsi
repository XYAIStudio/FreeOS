...
LangString OPENXYOS_WORKDIR ${LANG_SIMPCHINESE} "正在安装完整组织运行时（受管 Node、openXYOS 前端和业务后端）"
LangString OPENXYOS_WORKDIR ${LANG_ENGLISH} "Installing the full organization runtime (managed Node, openXYOS frontend, and business backend)"
LangString OPENXYOS_COPY_ZIP ${LANG_SIMPCHINESE} "正在复制完整 openXYOS 运行包"
LangString OPENXYOS_COPY_ZIP ${LANG_ENGLISH} "Copying the complete openXYOS runtime payload"
LangString OPENXYOS_OPTIONAL_SKIP ${LANG_SIMPCHINESE} "开发构建已明确关闭组织运行时；此构建不可作为完整产品发布。"
LangString OPENXYOS_OPTIONAL_SKIP ${LANG_ENGLISH} "The organization runtime was explicitly disabled for development; this build cannot be released as the full product."
LangString OPENXYOS_OPTIONAL_ABSENT ${LANG_SIMPCHINESE} "开发构建未包含组织运行包；此构建不可作为完整产品发布。"
LangString OPENXYOS_OPTIONAL_ABSENT ${LANG_ENGLISH} "The organization runtime is absent from this development build; it cannot be released as the full product."
