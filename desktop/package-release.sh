...
rebuilding desktop/portable/release/FreeOS-portable-<platform>-<version>.zip when it already exists.
EOF
}
...
staging="${REPO_ROOT}/desktop/portable/release/$(portable_staging_name "$plat")"
