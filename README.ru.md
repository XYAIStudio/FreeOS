...
**Двойная идентичность:** пользователи ПО FreeOS регистрируются и входят **локально** на хосте (это не официальные аккаунты Octop). Модуль организации — независимая тестовая среда со своей системой пользователей; она **не** является источником истины для личности хоста. Не публикуйте API-ключи, токены и реальные данные клиентов.
