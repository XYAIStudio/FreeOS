    ...
    <MemoryRouter initialEntries={["/organization"]}>
      <Routes>
        ...
        <Route
          ...
          element={<div data-testid="org-reflections-page">reflections</div>}
        />
        <Route
...
describe("OrganizationPage", () => {
  ...
  it("opens in-host governance without a sidecar iframe", async () => {
    renderOrg();
    fireEvent.click(await screen.findByTestId("org-open-governance"));
    expect(
      await screen.findByTestId("org-governance-page"),
    ).toBeInTheDocument();
    expect(screen.queryByTestId("org-browser-frame")).toBeNull();
  });

  it("opens in-host knowledge without a sidecar iframe", async () => {
    renderOrg();
  ...
  it("opens in-host reflections without a sidecar iframe", async () => {
    renderOrg();
    fireEvent.click(await screen.findByTestId("org-open-reflections"));
    expect(
      await screen.findByTestId("org-reflections-page"),
    ).toBeInTheDocument();
    expect(screen.queryByTestId("org-browser-frame")).toBeNull();
  });

  it("opens in-host organization settings without a sidecar iframe", async () => {
    renderOrg();
